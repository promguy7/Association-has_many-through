...
class DoctorsControllerTest < ActionController::TestCase
  ...
  test "should create doctor" do
    assert_difference('Doctor.count') do
      post :create, doctor: { address: @doctor.address, name: @doctor.name, title: @doctor.title }
    end
  ...
  test "should update doctor" do
    patch :update, id: @doctor, doctor: { address: @doctor.address, name: @doctor.name, title: @doctor.title }
    assert_redirected_to doctor_path(assigns(:doctor))
  end
